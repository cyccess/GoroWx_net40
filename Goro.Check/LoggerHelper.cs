...
namespace Goro.Check
{
    ...
    public class Log4Helper : ILogger
    {
        ...
        static Log4Helper()
        {
            ILoggerRepository repository = LogManager.CreateRepository("Goro");
            XmlConfigurator.Configure(repository, new FileInfo(AppDomain.CurrentDomain.BaseDirectory + "Web.config"));
            log4 = LogManager.GetLogger(repository.Name, "Goro");
        }
